...
# Can use any model that supports function calling, e.g. 'google-gla:gemini-1.5-flash'
# joke_generation_agent = Agent(
#     'google-gla:gemini-1.5-flash', output_type=list[str]
# )
joke_generation_agent = Agent("openai:gpt-4.1-2025-04-14", output_type=list[str])

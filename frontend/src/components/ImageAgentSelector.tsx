// components/ImageAgentSelector.tsx
...
export function ImageAgentSelector({
    selectedModel,
    onModelChange,
    className = "",
    showMetadata = true,
        ...
        <TooltipProvider>
            <div className={`flex flex-col gap-2 ${className}`}>
                <div className="flex gap-2 items-center">
                    <span className="text-sm font-medium text-muted-foreground">Image Agent:</span>
                    <Select value={selectedModel} onValueChange={onModelChange}>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                <SelectLabel>Choose Image Agent Model</SelectLabel>
